...
pub const TRANSFER_OUT_DISCRIMINATOR: [u8; 8] = [202, 137, 44, 229, 158, 255, 205, 174];
...
impl TransferOut {
    pub fn instruction(&self, args: TransferOutInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = TransferOutInstructionData::new().try_to_vec().unwrap();
...
pub struct TransferOutInstructionData {
    discriminator: [u8; 8],
}

impl TransferOutInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [202, 137, 44, 229, 158, 255, 205, 174],
        }
    }
...
impl Default for TransferOutInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct TransferOutInstructionArgs {
    pub amounts: u64,
}

impl TransferOutInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `TransferOut`.
///
/// ### Accounts:
///
...
impl TransferOutBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = TransferOutInstructionArgs {
...
/// `transfer_out` CPI accounts.
pub struct TransferOutCpiAccounts<'a, 'b> {
...
/// `transfer_out` CPI instruction.
pub struct TransferOutCpi<'a, 'b> {
    ...
    pub __args: TransferOutInstructionArgs,
}

impl<'a, 'b> TransferOutCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: TransferOutCpiAccounts<'a, 'b>,
        args: TransferOutInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `TransferOut` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` operator
...
#[derive(Clone, Debug)]
pub struct TransferOutCpiBuilder<'a, 'b> {
    instruction: Box<TransferOutCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> TransferOutCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(TransferOutCpiBuilderInstruction {
            __program: program,
            operator: None,
            config: None,
            vault: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = TransferOutCpi {
...
#[derive(Clone, Debug)]
struct TransferOutCpiBuilderInstruction<'a, 'b> {
