...
export function getJupiterAggregatorDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    JUPITER_AGGREGATOR_DISCRIMINATOR
  );
}

export type JupiterAggregatorInstruction<
...
export type JupiterAggregatorInstructionData = {
...
export type JupiterAggregatorInstructionDataArgs = {
  data: ReadonlyUint8Array;
...
export function getJupiterAggregatorInstructionDataCodec(): Codec<
  JupiterAggregatorInstructionDataArgs,
  JupiterAggregatorInstructionData
> {
  return combineCodec(
    getJupiterAggregatorInstructionDataEncoder(),
    getJupiterAggregatorInstructionDataDecoder()
  );
}

export type JupiterAggregatorAsyncInput<
...
> {
  ...
  return Object.freeze({
    ...
    data: getJupiterAggregatorInstructionDataEncoder().encode(
...
> = {
  ...
  data: JupiterAggregatorInstructionData;
};
...
>(
  ...
  return {
    ...
    data: getJupiterAggregatorInstructionDataDecoder().decode(instruction.data),
  };
}
