...
pub const GRANT_ACCESS_DISCRIMINATOR: [u8; 8] = [66, 88, 87, 113, 39, 22, 27, 165];
...
impl GrantAccess {
  pub fn instruction(&self, args: GrantAccessInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: GrantAccessInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = GrantAccessInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct GrantAccessInstructionData {
            discriminator: [u8; 8],
            }

impl GrantAccessInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for GrantAccessInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct GrantAccessInstructionArgs {
                  pub user: Pubkey,
      }

impl GrantAccessInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
/// Instruction builder for `GrantAccess`.
///
/// ### Accounts:
///
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = GrantAccess {
          ...
          let args = GrantAccessInstructionArgs {
  ...
  /// `grant_access` CPI accounts.
  pub struct GrantAccessCpiAccounts<'a, 'b> {
...
/// `grant_access` CPI instruction.
pub struct GrantAccessCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: GrantAccessInstructionArgs,
  }

impl<'a, 'b> GrantAccessCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: GrantAccessCpiAccounts<'a, 'b>,
              args: GrantAccessInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `GrantAccess` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` admin
          ...
          ///   4. `[]` rent
#[derive(Clone, Debug)]
pub struct GrantAccessCpiBuilder<'a, 'b> {
  instruction: Box<GrantAccessCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> GrantAccessCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(GrantAccessCpiBuilderInstruction {
      __program: program,
              admin: None,
              config: None,
              access: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = GrantAccessCpi {
...
#[derive(Clone, Debug)]
struct GrantAccessCpiBuilderInstruction<'a, 'b> {
