...
impl DflowAggregator {
  pub fn instruction(&self, args: DflowAggregatorInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DflowAggregatorInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = DflowAggregator {
                              input_mint: self.input_mint.expect("input_mint is not set"),
                                        ...
                                        dflow_program: self.dflow_program.unwrap_or(solana_pubkey::pubkey!("DF1ow4tspfHX9JwWJsAb9epbkA8hmpSEAtxXy1V27QBH")),
                      };
...
impl<'a, 'b> DflowAggregatorCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn receiver_output_token_account(&mut self, receiver_output_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn dflow_program(&mut self, dflow_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          dflow_program: self.instruction.dflow_program.expect("dflow_program is not set"),
                          __args: args,
            };
